...
/*----------------------------------------------------------------*/       
        ...
        while(iter.hasNext()){
            ...
            System.out.println(depi.getDeptNo()+" "+depi.getDnombre()+" "+depi.getLoc());
        }
        //INFORMATICA
        q = sesion.createQuery("select dnombre from Departamentos where dNombre=:dep");
                q.setString("dep", "INFORMATICA") ;
