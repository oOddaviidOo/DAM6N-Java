 ...
 * @author DAM 6N
 */
public class CancionPirataR implements Runnable{
private String hilo;

    public CancionPirataR(String hilo) {
        this.hilo=hilo;
    }
    public void run(){
...
String[] cancion={"Con diez canyones por banda,"
...
,"mi unica patria, la mar. "
          ...
          for (int i = 0; i < cancion.length; i++) {
            CancionPirataR  h=new CancionPirataR(cancion[i]);
			new Thread(h).start();
        }
